...
## Verify / test
- Full suite: `python3 -m pytest -q` (310 tests, ~17s, no live servers needed)
...
- `CODE_CANDIDATES` (default 3): number of parallel candidates in the multi-
  candidate code loop. CLI flag: `--code-candidates`.
